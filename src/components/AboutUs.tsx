...
export const AboutUs: React.FC = () => {
  ...
  return (
    <section className="py-20 bg-[#FAF8F4] border-t border-[#EAE2D7]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <h2 className="font-serif text-4xl sm:text-5xl font-bold text-[#2D2A26] leading-tight">
              A Brief About the Company Arvika Fashion.
            </h2>
            <p className="font-sans text-base text-[#2D2A26]/80 leading-relaxed">
            ...
            <p className="font-sans text-sm text-[#7B9B88] leading-relaxed">
            ...
            <div className="pt-6 border-t border-[#EAE2D7] space-y-5 text-xs font-sans">
              
              {/* Monthly Production Capacity Grid */}
              <div>
                <div className="flex items-center space-x-2 text-[#4E6E5D] font-montserrat font-bold uppercase tracking-wider text-[11px] mb-2.5">
                  <Factory className="w-4 h-4 text-[#7B9B88]" />
                  <span>Monthly Production Capacity</span>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5">
                  <div className="bg-white border border-[#EAE2D7] p-3 rounded-2xl shadow-xs">
                    <span className="text-[10px] text-[#7B9B88] uppercase font-bold block">Scarves</span>
                    <span className="text-sm font-serif font-bold text-[#2D2A26]">1,00,000 Pcs / Month</span>
                  </div>
                  <div className="bg-white border border-[#EAE2D7] p-3 rounded-2xl shadow-xs">
                    <span className="text-[10px] text-[#7B9B88] uppercase font-bold block">Garments</span>
                    <span className="text-sm font-serif font-bold text-[#2D2A26]">50,000 Pcs / Month</span>
                  </div>
                  <div className="bg-white border border-[#EAE2D7] p-3 rounded-2xl shadow-xs">
                    <span className="text-[10px] text-[#7B9B88] uppercase font-bold block">Bags</span>
                    <span className="text-sm font-serif font-bold text-[#2D2A26]">7,50,000 Pcs / Month</span>
                  </div>
                </div>
              </div>

              {/* Our Production Units */}
              <div className="bg-[#E8F0EC]/60 border border-[#D5E4DC] p-4 rounded-2xl space-y-2.5">
                <div className="flex items-center space-x-2 text-[#4E6E5D] font-montserrat font-bold uppercase tracking-wider text-[11px]">
                  <Building2 className="w-4 h-4 text-[#7B9B88]" />
                  <span>Our Specialized Production Units</span>
                </div>

                <div className="space-y-2 text-[#2D2A26]/90 text-[11px] leading-relaxed">
                  <div className="flex items-start gap-2">
                    <span className="bg-[#7B9B88] text-white w-4 h-4 rounded-full flex items-center justify-center text-[10px] font-bold shrink-0 mt-0.5">1</span>
                    <span><strong>Wool & Silk Printing Unit:</strong> Capacity of 2,500 to 3,000 pcs per day at Varanasi, UP (on contract basis).</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="bg-[#7B9B88] text-white w-4 h-4 rounded-full flex items-center justify-center text-[10px] font-bold shrink-0 mt-0.5">2</span>
                  ...
                  <div className="flex items-start gap-2">
                    <span className="bg-[#7B9B88] text-white w-4 h-4 rounded-full flex items-center justify-center text-[10px] font-bold shrink-0 mt-0.5">3</span>
          ...
          <div className="grid grid-cols-2 gap-4 relative">
            <div className="space-y-4">
              <img
                ...
                className="rounded-2xl object-cover h-64 w-full border border-[#D5E4DC] shadow-md"
              ...
              <img
                ...
                className="rounded-2xl object-cover h-48 w-full border border-[#D5E4DC] shadow-md"
                referrerPolicy="no-referrer"
              />
            </div>
            <div className="space-y-4 pt-8">
              <img
                ...
                referrerPolicy="no-referrer"
              />
              <div className="bg-[#7B9B88] text-white p-6 rounded-2xl border border-[#688875] shadow-xl flex flex-col justify-between h-64">
                <Award className="w-8 h-8 text-[#E8DCB8]" />
                <div>
                  <div className="font-serif text-2xl font-bold text-[#E8DCB8]">
                    Export Excellence
                  </div>
        ...
        <div className="border-t border-[#EAE2D7] pt-16 space-y-8">
          <div className="text-center space-y-2 max-w-3xl mx-auto">
            ...
            <p className="text-xs sm:text-sm text-[#7B9B88] font-sans leading-relaxed">
                ...
                >
                    ...
                    <div className="flex items-center space-x-3 min-w-0">
                      ...
                      <div className="min-w-0">
                        <div className="flex items-center gap-1.5 flex-wrap">
                          <h3 className="font-serif text-base sm:text-lg font-bold text-[#2D2A26] truncate">
                            {tab.title}
                          </h3>
                          <span className="text-[9px] font-montserrat font-bold uppercase tracking-wider px-2 py-0.5 rounded-full bg-white border border-gray-200 text-[#7B9B88]">
                            {tab.badge}
                          </span>
                        </div>
                        <p className="text-[11px] text-[#7B9B88] font-sans truncate mt-0.5">
                          {tab.subtitle}
                        </p>
                      </div>
                    </div>

                    <div className={`w-7 h-7 rounded-full border border-[#D5E4DC] flex items-center justify-center text-[#7B9B88] shrink-0 ml-2 transition-transform duration-300 ${
                      isOpen ? 'rotate-180 bg-[#7B9B88] text-white' : 'bg-white'
                    }`}>
                  ...
                  {isOpen && (
                    <div className="p-4 sm:p-5 pt-3 border-t border-gray-100 bg-white animate-fade-in space-y-2.5">
                      <ul className="grid grid-cols-1 gap-2 text-xs text-[#2D2A26]/85">
                        {tab.items.map((item, itemIdx) => (
                          <li 
                            key={itemIdx} 
                            className="bg-[#FAF8F4] border border-[#EAE2D7] p-2.5 rounded-xl flex items-start space-x-2 shadow-xs hover:border-[#7B9B88]/40 transition-colors"
                          >
        ...
        <div className="border-t border-[#EAE2D7] pt-12 flex flex-col items-center space-y-6 text-center">
          <span className="text-xs font-montserrat uppercase tracking-[0.25em] text-[#7B9B88] font-bold">
            SERVING 10+ INTERNATIONAL MARKETS
          </span>
          <div className="flex flex-wrap justify-center gap-3 text-xs font-sans font-semibold text-[#2D2A26]">
            {['🇩🇰 Denmark', '🇸🇪 Sweden', '🇩🇪 Germany', '🇫🇷 France', '🇬🇧 United Kingdom', '🇳🇱 Netherlands', '🇳🇴 Norway', '🇦🇪 United Arab Emirates', '🇺🇸 United States', '🇮🇳 India Direct'].map((c, i) => (
              <span key={i} className="bg-[#E8F0EC] border border-[#D5E4DC] px-4 py-2 rounded-full shadow-xs">
                {c}
              </span>
            ))}
          </div>
